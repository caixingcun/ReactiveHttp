 ...
 */
class SelfRemoteDataSource200(iActionEvent: IUIActionEvent?) : RemoteExtendDataSource<ApiService>(iActionEvent, ApiService::class.java) {
    ...
    override val baseUrl: String
        get() = HttpConfig.BASE_URL_GANK_IO
